...
export default function SensorChart({ isDarkMode }: Props) {
  ...
  return (
    <motion.div 
      ...
      className="w-full h-[220px] bg-white/60 dark:bg-[#0A2F1F]/40 backdrop-blur-md rounded-3xl p-4 md:p-6 border border-white/50 dark:border-white/10 shadow-sm"
    >
      <div className="flex justify-between items-center mb-4 px-2">
        <h3 className="font-bold text-[#0A2F1F] dark:text-white/90 text-sm">Soil Moisture History</h3>
