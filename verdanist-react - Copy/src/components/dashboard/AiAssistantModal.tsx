...
const MarkdownText = ({ text }: { text: string }) => {
  ...
  return (
    <div className="space-y-2 text-xs sm:text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
      {lines.map((line, idx) => {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative bg-gradient-to-b from-white/95 to-white/90 dark:from-[#082317]/95 dark:to-[#04150E]/95 backdrop-blur-3xl rounded-[2.5rem] w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-[0_40px_80px_rgba(0,0,0,0.5)] border border-white/60 dark:border-white/10 p-6 sm:p-8 z-10 space-y-6 scrollbar-none"
          >
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-white/50 font-semibold mt-1 max-w-xl leading-relaxed">
              ...
              <button
                onClick={onClose}
                className="w-9 h-9 rounded-full bg-gray-100 dark:bg-white/5 text-gray-400 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-500/10 dark:hover:bg-red-500/10 flex items-center justify-center transition-all cursor-pointer border border-transparent hover:border-red-500/20"
              >
            ...
            <form onSubmit={handleSearch} className="relative group">
              ...
              <input
                ...
                className="w-full bg-white/50 dark:bg-black/40 border border-gray-200/80 dark:border-white/10 rounded-2xl pl-11 pr-36 py-4 text-xs font-bold focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 dark:text-white shadow-inner transition-all placeholder-gray-400 dark:placeholder-white/20"
              />
              <button
                type="submit"
                disabled={loading}
            ...
            {!loading && !activeRecommend && (
              <div className="space-y-4">
                <h4 className="text-[10px] font-black text-gray-400 dark:text-white/40 uppercase tracking-widest flex items-center gap-1.5">
                  ...
                  {PLANT_PRESETS.map((plant) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between w-full z-10 shrink-0">
                        <span className="text-xl bg-gray-100/60 dark:bg-black/30 w-8 h-8 rounded-lg flex items-center justify-center filter drop-shadow-sm group-hover:scale-110 transition-transform duration-300 shrink-0">
                          {plant.emoji}
                        </span>
                      ...
                      <div className="z-10 min-w-0 flex-1 flex items-center">
                        <p className="text-[10px] sm:text-[11px] font-extrabold text-gray-900 dark:text-white leading-tight group-hover:text-emerald-500 transition-colors">
                          {plant.name}
                        </p>
                      </div>

                      {/* Bottom: Bento-style Parameter Grid */}
                      <div className="grid grid-cols-3 gap-0.5 bg-gray-100/60 dark:bg-black/30 p-1.5 rounded-xl border border-gray-100 dark:border-white/5 w-full shrink-0 z-10">
                        <div className="flex flex-col items-center justify-center text-center">
                          <span className="material-symbols-rounded text-[10px] text-red-500 leading-none">thermostat</span>
                          <span className="text-[8px] font-black mt-1 text-gray-600 dark:text-white/80 leading-none shrink-0">{plant.temp}°</span>
                        </div>
                        <div className="flex flex-col items-center justify-center text-center border-x border-gray-200/50 dark:border-white/5">
                          <span className="material-symbols-rounded text-[10px] text-blue-500 leading-none">humidity_low</span>
                          <span className="text-[8px] font-black mt-1 text-gray-600 dark:text-white/80 leading-none shrink-0">{plant.humidity}%</span>
                        </div>
                        <div className="flex flex-col items-center justify-center text-center">
                          <span className="material-symbols-rounded text-[10px] text-emerald-500 leading-none">potted_plant</span>
                          <span className="text-[8px] font-black mt-1 text-gray-600 dark:text-white/80 leading-none shrink-0">{plant.soil}%</span>
                        </div>
                      </div>
                    </button>
                  ))}
            ...
            {loading && (
              <div className="py-16 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 dark:text-white/40 font-semibold mt-1.5 max-w-sm mx-auto leading-relaxed">
            ...
            {!loading && activeRecommend && (
              ...
              >
                ...
                <div className={`flex items-start sm:items-center justify-between pb-5 border-b border-gray-100 dark:border-white/5 relative z-10 ${activeRecommend.imageUrl ? '-mt-16' : ''}`}>
                  <div className="flex items-end gap-3.5">
                    ...
                    <div className="relative z-10 pb-1">
                      ...
                      <h4 className={`text-xl sm:text-2xl font-black leading-tight tracking-tight ${activeRecommend.imageUrl ? 'text-gray-900 dark:text-white drop-shadow-[0_2px_10px_rgba(255,255,255,0.9)] dark:drop-shadow-lg' : 'text-gray-900 dark:text-white'}`}>
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-gray-100 dark:bg-white/5 text-[9px] font-black text-gray-500 dark:text-white/60 hover:bg-emerald-500/10 hover:text-emerald-600 dark:hover:bg-emerald-500/20 dark:hover:text-emerald-400 transition-all cursor-pointer border border-transparent hover:border-emerald-500/20"
                  >
                    Ganti Pilihan
                  </button>
                </div>
                ...
                <div className="space-y-2 relative z-10">
                  <span className="text-[9px] font-black text-gray-400 dark:text-white/40 uppercase tracking-widest flex items-center gap-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 relative z-10">
                    ...
                    <div className="bg-gradient-to-br from-red-500/5 to-pink-500/5 dark:from-red-500/10 dark:to-pink-500/5 rounded-2xl p-4 border border-red-500/10 text-center flex flex-col justify-between hover:scale-[1.03] transition-all">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="text-base font-black text-gray-900 dark:text-white mt-1.5 leading-none">
                    ...
                    <div className="bg-gradient-to-br from-teal-500/5 to-cyan-500/5 dark:from-teal-500/10 dark:to-cyan-500/5 rounded-2xl p-4 border border-teal-500/10 text-center flex flex-col justify-between hover:scale-[1.03] transition-all">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="text-xs font-black text-gray-900 dark:text-white mt-1.5 leading-none capitalize">
